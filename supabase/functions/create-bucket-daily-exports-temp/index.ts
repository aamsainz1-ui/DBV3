...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "text/csv", "application/json"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for daily-exports" ON storage.objects FOR SELECT USING (bucket_id = 'daily-exports');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for daily-exports" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'daily-exports');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for daily-exports" ON storage.objects FOR UPDATE USING (bucket_id = 'daily-exports');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for daily-exports" ON storage.objects FOR DELETE USING (bucket_id = 'daily-exports');`
    ];
    ...
    return new Response(JSON.stringify({
        ...
        name: 'daily-exports',
        public: true,
        allowed_mime_types: ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "text/csv", "application/json"],
